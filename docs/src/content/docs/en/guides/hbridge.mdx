...
Our code, besides supporting several gamepads thanks to Bluepad32, also supports several H-bridges thanks to its pinout. The examples shown here apply for both **ESP32 (Bluepad32)** and **Arduino-compatible boards (PS2)**.

<Aside type="caution">
This project was built using **ESP32 and Arduino-compatible microcontrollers**.  
If you don't have experience using them, we recommend you to watch some introductory tutorials.
</Aside>
...
As you can see, absolutely all of these examples have one thing in common: the presence of **IN1/IN3 and IN2/IN4** to control the direction of a motor.  
In our code there is support for a maximum of **two motors** and **two interfaces**:
